...
LocationService::LocationService() {
    ...
    timeZones["Hong Kong"] = TimeZone("Hong Kong", 8, false);
    ...
    timeZones["Mexico City"] = TimeZone("Mexico City", -6, true);
    timeZones["Toronto"] = TimeZone("Toronto", -4, true);
    timeZones["Buenos Aires"] = TimeZone("Buenos Aires", -3, false);
    timeZones["Rio De Janeiro"] = TimeZone("Rio de Janeiro", -3, true);
    ...
    timeZones["Kuala Lumpur"] = TimeZone("Kuala Lumpur", 8, false);
